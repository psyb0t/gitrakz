...
func newDocument(db *gorm.DB, opts ...gen.DOOption) document {
	...
	_document.TemplateID = field.NewString(tableName, "template_id")
	_document.Filter = field.NewString(tableName, "filter")
	_document.FormValues = field.NewString(tableName, "form_values")
	_document.Doc = field.NewString(tableName, "doc")
	_document.CreatedTS = field.NewInt64(tableName, "created_ts")
...
func (d *document) updateTableName(table string) *document {
	...
	d.FormValues = field.NewString(table, "form_values")
	d.Doc = field.NewString(table, "doc")
	d.CreatedTS = field.NewInt64(table, "created_ts")
...
func (d *document) fillFieldMap() {
	...
	d.fieldMap["form_values"] = d.FormValues
	d.fieldMap["doc"] = d.Doc
