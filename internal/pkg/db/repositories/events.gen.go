...
func newEvent(db *gorm.DB, opts ...gen.DOOption) event {
	...
	_event.TS = field.NewInt64(tableName, "ts")
	_event.Type = field.NewString(tableName, "type")
	_event.Owner = field.NewString(tableName, "owner")
	_event.Repo = field.NewString(tableName, "repo")
	_event.SHA = field.NewString(tableName, "sha")
	_event.Number = field.NewInt(tableName, "number")
	_event.Title = field.NewString(tableName, "title")
	_event.URL = field.NewString(tableName, "url")
	_event.Additions = field.NewInt(tableName, "additions")
	_event.Deletions = field.NewInt(tableName, "deletions")
	_event.Branch = field.NewString(tableName, "branch")
	_event.Raw = field.NewString(tableName, "raw")
...
func (e *event) updateTableName(table string) *event {
	...
	e.TS = field.NewInt64(table, "ts")
	e.Type = field.NewString(table, "type")
	e.Owner = field.NewString(table, "owner")
	e.Repo = field.NewString(table, "repo")
	e.SHA = field.NewString(table, "sha")
	e.Number = field.NewInt(table, "number")
	e.Title = field.NewString(table, "title")
	e.URL = field.NewString(table, "url")
	e.Additions = field.NewInt(table, "additions")
	e.Deletions = field.NewInt(table, "deletions")
	e.Branch = field.NewString(table, "branch")
	e.Raw = field.NewString(table, "raw")
...
func (e *event) fillFieldMap() {
	...
	e.fieldMap["repo"] = e.Repo
	e.fieldMap["sha"] = e.SHA
	e.fieldMap["number"] = e.Number
	e.fieldMap["title"] = e.Title
	e.fieldMap["url"] = e.URL
	e.fieldMap["additions"] = e.Additions
	e.fieldMap["deletions"] = e.Deletions
	e.fieldMap["branch"] = e.Branch
	e.fieldMap["raw"] = e.Raw
}
...
type IEventDo interface {
	...
	ListOwners() (result []string, err error)
	ListRepos(owner string) (result []string, err error)
}

// ListOwners returns every distinct owner, sorted ascending.
//
// SELECT DISTINCT owner FROM @@table ORDER BY owner
func (e eventDo) ListOwners() (result []string, err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT DISTINCT owner FROM events ORDER BY owner ")
...
func (e eventDo) ListRepos(owner string) (result []string, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, owner)
	generateSQL.WriteString("SELECT DISTINCT repo FROM events WHERE owner = ? ORDER BY repo ")
