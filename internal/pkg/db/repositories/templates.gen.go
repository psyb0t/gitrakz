...
func newTemplate(db *gorm.DB, opts ...gen.DOOption) template {
	...
	_template.Description = field.NewString(tableName, "description")
	_template.Form = field.NewString(tableName, "form")
	_template.Transform = field.NewString(tableName, "transform")
	_template.Layout = field.NewString(tableName, "layout")
	_template.Exports = field.NewString(tableName, "exports")
	_template.Model = field.NewString(tableName, "model")
	_template.Builtin = field.NewBool(tableName, "builtin")
	_template.CreatedTS = field.NewInt64(tableName, "created_ts")
...
func (t *template) updateTableName(table string) *template {
	...
	t.Form = field.NewString(table, "form")
	t.Transform = field.NewString(table, "transform")
	t.Layout = field.NewString(table, "layout")
	t.Exports = field.NewString(table, "exports")
	t.Model = field.NewString(table, "model")
	t.Builtin = field.NewBool(table, "builtin")
	t.CreatedTS = field.NewInt64(table, "created_ts")
...
func (t *template) fillFieldMap() {
	...
	t.fieldMap["form"] = t.Form
	t.fieldMap["transform"] = t.Transform
	t.fieldMap["layout"] = t.Layout
	t.fieldMap["exports"] = t.Exports
